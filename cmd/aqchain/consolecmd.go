...
See https://gitee.com/aqchain/go-ethereum/wiki/JavaScript-Console.`,
	}
...
JavaScript API. See https://gitee.com/aqchain/go-ethereum/wiki/JavaScript-Console`,
	}
)
...
func remoteConsole(ctx *cli.Context) error {
	...
	if endpoint == "" {
		...
		endpoint = fmt.Sprintf("%s/aqchain-blockchain.ipc", path)
	}
