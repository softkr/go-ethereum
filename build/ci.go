...
import (
	...
	"gitee.com/aqchain/go-ethereum/internal/build"
)
...
var (
	...
	allToolsArchiveFiles = []string{
		...
		executablePath("evm"),
		executablePath("aqchain-blockchain"),
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "gitee.com/aqchain/go-ethereum/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "gitee.com/aqchain/go-ethereum/mobile")
