...
import "gitee.com/aqchain/go-ethereum/accounts/abi"

// tmplData is the data structure required to fill the binding template.
type tmplData struct {
	Package   string                   // Name of the package to place the generated file in
	Contracts map[string]*tmplContract // List of contract to generate into this file
}
...
{{range $contract := .Contracts}}
	...
	{{if .InputBin}}
		// {{.Type}}Bin is the compiled bytecode used for deploying new contract.
...
{{range $contract := .Contracts}}
	public class {{.Type}} {
		...
		{{if .InputBin}}
			// BYTECODE is the compiled bytecode used for deploying new contract.
