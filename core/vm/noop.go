...
func (NoopStateDB) SubContribution(common.Address, *big.Int)                                {}
func (NoopStateDB) AddContribution(common.Address, *big.Int)                                {}
func (NoopStateDB) GetContribution(common.Address) *big.Int                                 { return nil }
