...
import (
	...
	"gitee.com/aqchain/go-ethereum/swarm/network/kademlia"
	"gitee.com/aqchain/go-ethereum/swarm/services/swap"
...
NodeID serves as the owner of payment contract and signer of proofs of transfer.
