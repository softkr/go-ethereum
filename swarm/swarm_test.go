...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/aqchain-blockchain.ipc",
			endpoint:    "/data/testnet/aqchain-blockchain.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/aqchain-blockchain.ipc",
			endpoint:    "/data/testnet/aqchain-blockchain.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/aqchain-blockchain.ipc",
			endpoint:    "/data/testnet/aqchain-blockchain.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/aqchain-blockchain.ipc",
			endpoint:    "/data/testnet/aqchain-blockchain.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
