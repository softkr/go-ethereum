...
// execute such calls. For applications which are structured around specific contract,
...
type FilterQuery struct {
	...
	Addresses []common.Address // restricts matches to events created by specific contract
