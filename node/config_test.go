...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "aqchain-blockchain.ipc", false, filepath.Join(os.TempDir(), "aqchain-blockchain.ipc")},
		{"data", "aqchain-blockchain.ipc", false, "data/aqchain-blockchain.ipc"},
		{"data", "./aqchain-blockchain.ipc", false, "./aqchain-blockchain.ipc"},
		{"data", "/aqchain-blockchain.ipc", false, "/aqchain-blockchain.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "aqchain-blockchain.ipc", true, `\\.\pipe\gttc.ipc`},
		{"data", "aqchain-blockchain.ipc", true, `\\.\pipe\gttc.ipc`},
